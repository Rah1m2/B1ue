	...
	function Vb(a, b, c) {
		...
		c.queue ||
			...
			1 === a.nodeType &&
				...
				(j = n.css(a, "display")),
				"inline" === ("none" === j ? tb(a.nodeName) : j) && "none" === n.css(a, "float") && (m.display = "inline-block")),
			c.overflow &&
				((m.overflow = "hidden"),
				k.always(function () {
		...
		for (d in b)
			if (((e = b[d]), Nb.exec(e))) {
				...
				l[d] = (p && p[d]) || n.style(a, d);
			} else j = void 0;
		if (n.isEmptyObject(l)) "inline" === ("none" === j ? tb(a.nodeName) : j) && (m.display = j);
		else {
			p ? "hidden" in p && (o = p.hidden) : (p = L.access(a, "fxshow", {})),
				f && (p.hidden = !o),
				o
					? n(a).show()
					: k.done(function () {
